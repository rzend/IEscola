...
namespace IEscola.Infra.Repositories
{
    public class ProfessorRepository : IProfessorRepository
    {
        private readonly List<Professor> _professorList = new List<Professor> {
            new Professor(Guid.Parse("36062FEB-2011-4142-BC38-48413606BC94"), "Antonio", "01234567890", new DateTime(1990, 2, 27), Guid.Parse("292499B0-2B09-4787-92CF-8C352456EAE0")),
            new Professor(Guid.Parse("EB093931-E526-4EAB-B444-D9ED7B583F43"), "José", "22222222222", new DateTime(1985, 2, 21), Guid.Parse("292499B0-2B09-4787-92CF-8C352456EAE0")),
            new Professor(Guid.Parse("3BF8376A-2E89-4B28-91B5-FA9999BBD1A3"), "João", "11111111111", new DateTime(1983, 12, 31), Guid.Parse("FF829D06-A51E-413A-A800-8DA041F60AA6")),
